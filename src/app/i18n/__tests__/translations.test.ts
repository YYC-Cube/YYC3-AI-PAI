...
describe('Critical Translation Keys', () => {
  ...
  it('all section names should not contain truncated content', () => {
    const placeholderKeys = [
      ...
      'syncing', 'placeholder', 'searchPlaceholder', 'systemPromptPlaceholder', 
      'contentPlaceholder', 'cmdPlaceholder', 'layoutNamePlaceholder', 
      'layoutImportPlaceholder', 'search', 'placeholder', 'recording', 
      'commitPlaceholder', 'searchPlaceholder', 'inferring', 'searchPlaceholder',
