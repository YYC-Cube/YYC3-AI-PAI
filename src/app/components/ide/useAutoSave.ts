...
export function useAutoSave(opts: UseAutoSaveOptions): AutoSaveAPI {
  ...
  }, [editorPrefs.autoSave, fileContentMap, locale, formatTime]);
  ...
  }, [editorPrefs.autoSave, editorDirty, fileContentMap, locale, selectedFile, editorCode, setEditorDirty, formatTime]);
