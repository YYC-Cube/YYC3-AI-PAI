...
function buildPreviewDocument(opts: BuildOptions): string {
  const { code, language, isCyberpunk, fontDisplay, fontMono, fontBody, background, foreground, primary, primaryDim } = opts
...
export const LivePreview = memo(function LivePreview({
  ...
  }, [previewHTML, preview.mode, preview.delay, code.length, preview])
  ...
  }, [preview.autoRefreshInterval, preview])
  ...
  }, [preview.scrollSyncEnabled, onScrollSync, preview])
