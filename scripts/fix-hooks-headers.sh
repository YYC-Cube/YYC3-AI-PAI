...
# Hooks 文件列表
HOOKS_FILES=(
    "useKeyboardShortcuts.ts:键盘快捷键Hook，管理键盘快捷键:hook,keyboard,shortcut,react"
)
...
fix_header() {
    ...
    local file_path="src/app/hooks/$filename"
